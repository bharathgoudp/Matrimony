# Generated by Django 3.0.1 on 2020-02-12 10:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Agefrom', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='matriapp.Agee')),
                ('Ageto', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='matriapp.Ageto')),
                ('Caste', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='matriapp.Castee')),
                ('City', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='matriapp.Cityy')),
                ('Country', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='matriapp.Countryy')),
                ('Height', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='matriapp.Heightt')),
                ('MotherTongue', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='matriapp.MotherTonguee')),
                ('Raasi', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='matriapp.Raasii')),
                ('Religion', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='matriapp.Religionn')),
                ('Star', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='matriapp.Starr')),
                ('State', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='matriapp.Statee')),
                ('Subcaste', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='matriapp.Subcastee')),
                ('Weight', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='matriapp.Weightt')),
                ('prefredheigth', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='matriapp.Preheightt')),
            ],
        ),
    ]
