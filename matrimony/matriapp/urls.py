...
urlpatterns = [
     ...
     path('saved/',views.matrisave_1,name='save1'),
     path('saved/',views.matrisave_2,name='save2'),
      path('saved/',views.matrisave_3,name='save3'),
       path('saved/',views.matrisave_4,name='save4'),
